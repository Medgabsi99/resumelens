            ...
            {!currentSession.evaluation ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ display: "flex", justifyItems: "center", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  {isSupportedSpeech && (
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      >
                        {isRecording ? <><Square size={11} /><span>Stop Recording</span></> : <><Mic size={11} /><span>Speak Answer</span></>}
                      </button>
                    </div>
                  )}
                </div>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", gap: 12 }}>
                  ...
                  >
                    {isEvaluating ? "Hiring Manager is evaluating..." : <><span>Submit Answer & Grade</span><ArrowRight size={14} /></>}
                  </button>
                </div>
                {evalError && (
                  <div style={{ color: "#f87171", fontSize: 13, textAlign: "center", marginTop: 8, display: "flex", alignItems: "center", justifyContent: "center", gap: 5 }}>
                    <AlertTriangle size={13} /><span>{evalError}</span>
                  </div>
                )}
              </div>
            ) : (
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", borderTop: "1px solid #282836", paddingTop: 16 }}>
                    ...
                    >
                      {currentIdx + 1 === questions.length
                        ? <><span>Finish Simulator</span><Flag size={13} /></>
                        : <><span>Next Question</span><ChevronRight size={14} /></>}
                    </button>
                </div>
              </div>
            )}
